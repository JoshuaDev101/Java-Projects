    ...
    public static void main(String[] args) {
        ...
        while (true){
            try { 
                ...
                System.out.print("Enter " + name1 +  "  initiative:");
                ...
                //creating object
                Gladiator1 glad1 =
                    new Gladiator1 (name1, health, damage, defense, initiative);
          Gladiator1 glad2  =
                  new Gladiator1(enemyName, enemyHealth, randDamage, randDefense, randInit);
          
          
          System.out.println(
          Gladiator1.fight(glad1, glad2).getName()
          + " wins.");
