...
public final class Gladiator1 {
    // instance variable - declared outside any method constructor 
    ...
    public Gladiator1(String name, double health, int damage, int defense,
            int initiative) {
        setName(name);
        setHealth(health);
        setDamage(damage);
    ...
    public void setHealth(double newHealth) {
        if (newHealth <= 0) {
            System.out.println("Health cannot"
    ...
    public static void displayGladiatorStats(Gladiator1 glad){
    ...
    public static Gladiator1 fight (Gladiator1 glad1, 
            Gladiator1 glad2 ){
